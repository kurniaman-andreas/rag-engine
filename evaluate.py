...
# df.to_csv("evaluation/eval_gemini_5_noadapt.csv", index=False)
...
for query in questions:
    # Dapatkan jawaban dari RAG pipeline
    output = rag_chain.invoke({
        "question": query,
        "chat_history": []
    })
    ...
    # Dapatkan context dokumen dari retriever
    retrieved_docs = retriever.get_relevant_documents(query)
    context_chunk = [doc.page_content for doc in retrieved_docs]
